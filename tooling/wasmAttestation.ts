...
const WASM_PATH = "apexchainx_calculator/target/wasm32-unknown-unknown/release/apexchainx_calculator.wasm";
const CHECKSUM_FILE = "artifacts/apexchainx_calculator.wasm.sha256";
